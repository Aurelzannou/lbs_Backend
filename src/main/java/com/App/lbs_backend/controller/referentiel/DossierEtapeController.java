...
import com.App.lbs_backend.service.referentiel.DossierEtapeService;
...
public class DossierEtapeController {
    ...
    public ResponseEntity<ApiResponse<List<DossierEtapeResponse>>> getByDossierId(@PathVariable Long dossierEleveId, HttpServletRequest req) {
        return ResponseEntity.ok(ApiResponse.apiSuccess(
